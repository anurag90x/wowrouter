...
class TestRouter(unittest.TestCase):
    ...
    def test_add_routes_dynamic(self):
        self.thing.add_route('/doge/<woof:string>/extra', doge)
        action = self.thing.load_route('/doge/magic/extra')
        self.assertEqual('magic', action())
